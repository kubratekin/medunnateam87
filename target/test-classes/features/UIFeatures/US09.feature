...
Feature: US_09
  ...
  Scenario: TC_0001_Admin can view patient information by navigating view portal
    And User enters username "vusalgasimov" and password "vusalgasimov" with Admin credentials and clicks Sign in button
  ...
  Scenario: TC_0002_Staff can view patient information by navigating view portal
    And User enters username "Jdoe" and password "12J34d!" with Staff credentials and clicks Sign in button
